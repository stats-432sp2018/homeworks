...
>  __Instructions:__ You must submit this homework by pushing the "hw4.Rmd" file to your team's repo. Note that that is the __only__ file you will be allowed to push. Commit early and often.
...
* Does adding in year and country as covariates improve the predictive
  ability of a linear model which includes log GDP and under-valuation?
    ...
    - Explain why using 5-fold cross-validation would be hard here.
